...
<body>
    <form action='{{route('reg_profile') }}' method="POST">
        @csrf
        ...
        <label for="birth_date" id="birth_date" name="birth_date">Birth date: </label>
        <input type="date" id="birth_date" name="date"> <br><br>
